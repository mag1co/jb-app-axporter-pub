...
**Project-level** (configurable per project):

| Setting | Description | Default |
| --- | --- | --- |
| defaultFileName | Prefix for exported file names | table-export |
| dateInFileName | Append date (YYYY-MM-DD) to file name | true |
| notifyMode | After export: `popup` (result in widget) or `alert` (toast + close) | popup |

**Global** (admin only):

| Setting | Description | Default |
| --- | --- | --- |
| logLevel | Backend logging: `no_log`, `minimal`, `debug` | no_log |
